 ...
 */
@Mapper
public interface PhInstructionsMapper extends HospitalBaseMapper<PhInstructions> {
	/**
	...
	* @Date: 2021/6/4
	*/
	PhInstructionsDTO getInstructionByProductId(@Param("drugId") Long drugId);
	/**
	* @Description: 关键字搜索
	...
	* @Date: 2021/6/9
	*/
    List<ShopProductDTO> keywordSearch(@Param("page") IPage<ShopProductDTO> page, @Param("queryParam") ShopProductQueryParamDTO queryParam);
}
