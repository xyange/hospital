...
public class EnArticlesController {
    ...
    @GetMapping("/page" )
    @PreAuthorize("@pms.hasPermission('admin_enarticles_view')" )
    ...
    @SysLog("新增文章表" )
    @PostMapping
    @PreAuthorize("@pms.hasPermission('admin_enarticles_add')" )
    ...
    @SysLog("修改文章表" )
    @PutMapping
    @PreAuthorize("@pms.hasPermission('admin_enarticles_edit')" )
    ...
    @SysLog("通过id删除文章表" )
    @DeleteMapping("/{id}" )
    @PreAuthorize("@pms.hasPermission('admin_enarticles_del')" )
