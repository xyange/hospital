...
public class EpubUtil {
    ...
    public static Book getEpubBookFormOss(String fileUrl) throws IOException {
    	URL url = new URL(fileUrl);
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		Book book=null;
		EpubReader reader = new EpubReader();
		try {
			book = reader.readEpub(conn.getInputStream());
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			try{
    ...
    public static Book getEpubBook(String fileUrl) throws IOException {
