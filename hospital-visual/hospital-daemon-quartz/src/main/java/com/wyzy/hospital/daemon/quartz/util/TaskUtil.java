...
import com.wyzy.hospital.daemon.quartz.config.HospitalQuartzFactory;
import com.wyzy.hospital.daemon.quartz.entity.SysJob;
import lombok.extern.slf4j.Slf4j;
import org.quartz.*;
import org.springframework.stereotype.Component;

import static com.wyzy.hospital.daemon.quartz.constants.HospitalQuartzEnum.*;
	...
	public void addOrUpateJob(SysJob sysjob, Scheduler scheduler) {
		...
		try {
			...
			if (trigger == null) {
				...
				JobDetail jobDetail = JobBuilder.newJob(HospitalQuartzFactory.class).withIdentity(jobKey).build();
				// 将任务信息添加到任务信息中
