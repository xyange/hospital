...
package com.wyzy.hospital.daemon.elastic;

import com.wyzy.hospital.common.feign.annotation.EnableHospitalFeignClients;
import com.wyzy.hospital.common.job.annotation.EnableHospitalXxlJob;
 ...
 */
@EnableHospitalXxlJob
@EnableHospitalSwagger2
@EnableHospitalFeignClients
@EnableHospitalResourceServer
@EnableDiscoveryClient
@SpringBootApplication
public class HospitalDaemonElasticJobApplication {

	public static void main(String[] args) {
		SpringApplication.run(HospitalDaemonElasticJobApplication.class, args);
	}
