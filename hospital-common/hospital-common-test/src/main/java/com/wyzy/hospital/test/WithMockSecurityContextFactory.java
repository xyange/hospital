package com.wyzy.hospital.test;
...
import com.wyzy.hospital.test.annotation.WithMockOAuth2User;
...
public class WithMockSecurityContextFactory implements WithSecurityContextFactory<WithMockOAuth2User> {
	...
	private final String TOKEN_URL = "http://hospital-auth/oauth/token";
