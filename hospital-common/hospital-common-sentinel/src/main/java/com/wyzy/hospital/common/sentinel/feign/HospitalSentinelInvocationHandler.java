 ...
 */
@Slf4j
public class HospitalSentinelInvocationHandler implements InvocationHandler {
	...
	HospitalSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			HospitalSentinelInvocationHandler other = (HospitalSentinelInvocationHandler) obj;
