package com.wyzy.hospital.common.job;

import java.util.stream.Collectors;

import com.wyzy.hospital.common.job.properties.XxlJobProperties;
...
@ComponentScan("com.wyzy.hospital.common.job.properties")
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://hospital-xxl:9080/xxl-job-admin"
