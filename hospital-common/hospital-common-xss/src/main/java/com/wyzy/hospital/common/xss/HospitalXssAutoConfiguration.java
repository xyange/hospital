...
package com.wyzy.hospital.common.xss;

import com.wyzy.hospital.common.xss.config.HospitalXssProperties;
import com.wyzy.hospital.common.xss.core.FormXssClean;
import com.wyzy.hospital.common.xss.core.JacksonXssClean;
import com.wyzy.hospital.common.xss.core.XssCleanInterceptor;
...
@EnableConfigurationProperties(HospitalXssProperties.class)
@ConditionalOnProperty(value = "security.xss.enabled", havingValue = "true", matchIfMissing = true)
public class HospitalXssAutoConfiguration implements WebMvcConfigurer {

	private final HospitalXssProperties xssProperties;
