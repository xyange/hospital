...
package com.wyzy.hospital.common.data.datascope;
...
import com.wyzy.hospital.admin.api.feign.RemoteDataScopeService;
 ...
 * 默认data scope 判断处理器
 */
public class HospitalDefaultDatascopeHandle implements DataScopeHandle {
