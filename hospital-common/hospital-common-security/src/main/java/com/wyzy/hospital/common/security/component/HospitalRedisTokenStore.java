 ...
 */
public class HospitalRedisTokenStore implements TokenStore {
	...
	public HospitalRedisTokenStore(RedisConnectionFactory connectionFactory, KeyStrResolver resolver) {
